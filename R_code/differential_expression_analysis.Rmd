...
knitr::opts_chunk$set(echo = T,fig.width = 5)
```
...
volcanoplot(fit2, coef=ct, main=colnames(fit2)[ct], pch=20, cex=1,
            highlight=length(which(dT[,ct]!=0)), names=rep('O', nrow(fit2)))
```
...
```{r}
plotSA(fit2, main="Mean variance trend, GSE45827", cex=1, trend = T)
```
